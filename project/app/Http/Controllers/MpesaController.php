...
class MpesaController extends Controller
{
    ...
    public function customerMpesaSTKPush(Request $request)
    {
        ...
        $phone_number = $this->formatNumber($request->phone_number);
        $curl_post_data = [
            ...
            'CallBackURL' => 'https://3ad8bef2de89.ngrok.io/api/v1/hlab/stk/confirmation',
...
//        return $curl_response;
    ...
    {
        $consumer_key="zT8Es1wsL6T7VKGOWj6o4QNTU3KrVW7U";
        $consumer_secret="e0VSq2DG8npoJRZ8";
    ...
    public function mpesaRegisterUrls()
    {
        ...
        curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode(array(
            ...
            'ConfirmationURL' => "https://3ad8bef2de89.ngrok.io/api/v1/hlab/transaction/confirmation",
            'ValidationURL' => "https://3ad8bef2de89.ngrok.io/api/v1/hlab/validation"
        )));
        $curl_response = curl_exec($curl);
        echo $curl_response;
    }
    ...
    public function simulate() {
        ...
        $curl = curl_init();
        curl_setopt($curl, CURLOPT_URL, 'https://sandbox.safaricom.co.ke/mpesa/c2b/v1/simulate');
        curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-Type:application/json','Authorization:Bearer '.$this->generateAccessToken()));
        ...
        $curl_post_data = array(
            ...
            'Amount' => 2000,
            'Msisdn' => 254, //your number (Simulation purposes)
